  ...
  if ($users[$_GET["player"]]["nick"] != "") {
    ...
    if ($utimes == NULL) {
      ...
      for ($x = 0;$x < 54;$x++) {
        ...
        echo("<td class=\"times\"><center>" . ($t > 0 ? "+" . formatElmaTime(abs($targets[$x+1][$t-1]-$utimes[$x+1][1])) : "-") . "</center></td>");
      ...
      echo($targetz[7] . " beginner time" . $ts . "<br/>");
